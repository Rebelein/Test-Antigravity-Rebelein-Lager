  ...
  const startScanner = async () => {
      ...
      try {
          ...
          await scanner.start(
              ...
              { 
                  fps: 15, 
                  qrbox: { width: 280, height: 100 }, // Optimized for mixed (Barcodes/QR)
                  aspectRatio: 1.0,
                  formatsToSupport: [ 
          ...
          <div className="fixed inset-0 z-[100] bg-black flex flex-col">
              ...
              <div className="flex-1 relative bg-black">
                 ...
                 {!scannedLocation && !showCategorySelector && !selectedArticle && cameraError && (
                     <div className="absolute inset-0 flex items-center justify-center p-6 text-center text-red-400 bg-black/90">
