...
import { GlassModal, Button, StatusBadge } from './UIComponents';
                ...
                <div className="flex flex-col h-full overflow-hidden">
                    ...
                    <div className="p-4 border-b border-gray-200 dark:border-white/10 bg-gray-50/50 dark:bg-black/20">
                        <div className="flex justify-between items-start">
                            ...
                            <button onClick={onClose} className="p-2 bg-gray-100 dark:bg-white/5 rounded-full text-gray-500 dark:text-white/60 hover:text-gray-900 dark:hover:text-white ml-3"><X size={20} /></button>
                        </div>
                    </div>
