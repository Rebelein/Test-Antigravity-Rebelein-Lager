        ...
        >
            <div className="p-6 flex flex-col items-center text-center">
                ...
                <p className="text-white/60 mb-6 text-sm">
                    Es existiert bereits eine aktive Kommission mit der Auftragsnummer <span className="text-white font-mono font-bold px-1.5 py-0.5 bg-white/5 rounded">{existingCommission.order_number}</span>.
                </p>

                <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 mb-8 text-left">
                    <div className="flex justify-between items-start mb-2">
                        <span className="text-[10px] font-bold text-white/40 uppercase tracking-wider">Vorhandene Kommission</span>
                    ...
                    <div className="text-xs text-white/40">Erstellt am {new Date(existingCommission.created_at).toLocaleDateString('de-DE')}</div>
                </div>
