        ...
        <>
            <div className={`px-6 py-5 border-b border-border bg-muted backdrop-blur-sm flex items-center gap-3 shrink-0`}>
                ...
                <div className="flex items-center gap-2 flex-1">
                    <Factory size={20} className="dark:text-emerald-400 text-emerald-800" />
                    <h2 className="text-xl font-bold text-foreground">Kommissionen</h2>
                </div>
                ...
                <button
                    ...
                    className="p-2 bg-muted rounded-lg text-muted-foreground hover:text-foreground transition-colors mr-2"
            ...
            <div className="flex md:hidden border-b border-border shrink-0">
                {(['open', 'backlog', 'returns'] as const).map((tab) => {
                    ...
                    const activeColor = tab === 'open' ? 'text-foreground' : tab === 'backlog' ? 'dark:text-rose-400 text-rose-800' : 'text-purple-400';
