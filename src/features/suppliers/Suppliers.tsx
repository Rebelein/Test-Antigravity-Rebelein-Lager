          ...
          <GlassCard key={supplier.id} className="relative group">
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => handleOpenEdit(supplier)} className="p-2 rounded-lg bg-muted hover:bg-muted text-muted-foreground hover:text-white"><Edit2 size={16} /></button>
                <button onClick={() => handleDelete(supplier.id, supplier.name)} className="p-2 rounded-lg bg-muted hover:bg-red-500/20 text-muted-foreground hover:text-red-300"><Trash2 size={16} /></button>
              </div>
            </div>
          </GlassCard>
        ))}
          ...
          <GlassCard className="w-full max-w-lg" title={editingId ? "Lieferant bearbeiten" : "Neuer Lieferant"}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 mt-2">
              ...
              <div className="pt-4 border-t border-border">
                ...
                <textarea
                  className="w-full h-24 bg-muted border border-border rounded-xl p-3 text-xs font-mono text-white placeholder-white/20 focus:outline-none focus:ring-1 focus:ring-emerald-500"
