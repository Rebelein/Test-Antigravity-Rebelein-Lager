        ...
        <div className="flex flex-col h-full bg-transparent text-slate-100">
            ...
            <div className="flex-1 overflow-y-auto space-y-6 min-h-0 pb-4">
                ...
                <div className="space-y-2">
                    <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider px-1">Stammdaten</h3>
                ...
                {/* History Section */}
                <div>
                    <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-wider px-1 mb-2 flex justify-between items-center">
            ...
            {/* Footer Actions */}
            <div className="shrink-0 pt-4 mt-2 border-t border-border flex gap-2">
