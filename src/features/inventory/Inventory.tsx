...
const Inventory = () => {
    ...
    const [isHeaderExpanded, setIsHeaderExpanded] = usePersistentState<boolean>('inventory-filter-expanded', !isMobile);
    ...
    const lowStockCount = useMemo(() => {
        return articles.filter(article => {
            ...
            return article.stock < article.targetStock;
        }).length;
    }, [articles, currentWarehouseId]);
    ...
    const listContent = (
        <div
            ...
            onClick={(e) => {
                ...
                if (!target.closest('[data-article-card]')) {
                    setExpandedArticleId(null);
                    setQuickStockAmount(0);
                }
            }}
